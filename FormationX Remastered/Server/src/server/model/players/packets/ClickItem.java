	...
	public void processPacket(Client c, int packetType, int packetSize) {
		...
		*/
		...
		if(itemId == 8008) {
             ...
             c.getPA().teleTabTeleport(3222, 3213, 0, "teleTab");
        }
		if(itemId == 8009) {
             c.getItems().deleteItem(8009,c.getItems().getItemSlot(8009),1);
             c.getPA().teleTabTeleport(2944, 3370, 0, "teleTab");
		...
		if(itemId == 8010) {
             ...
             c.getPA().teleTabTeleport(2726, 3485, 0, "teleTab");
        }
		if(itemId == 8011) {
             c.getItems().deleteItem(8011,c.getItems().getItemSlot(8011),1);
             c.getPA().teleTabTeleport(2662, 3306, 0, "teleTab");
        }
		if(itemId == 8013) {
             c.getItems().deleteItem(8013,c.getItems().getItemSlot(8013),1);
             c.getPA().teleTabTeleport(3090, 3481, 0, "teleTab");
        }
		/*
		*Start Of Box Sets
		*/
