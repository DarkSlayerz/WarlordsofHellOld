...
public abstract class Player {
	...
	public ArrayList<String> killedPlayers = new ArrayList<String>();
	 public TimedEventContainer timedEventContainer = new TimedEventContainer();
	...
	public long lastPlayerMove, lastoverload, lastPoison, lastPoisonSip,
			poisonImmune, lastSpear, lastProtItem, dfsDelay, lastVeng, lastClick,
	...
	public boolean fullVoidMelee() {
		...
		|| playerEquipment[playerHat] == 13355 && playerEquipment[playerLegs] == 13352 && playerEquipment[playerChest] == 13354
		|| playerEquipment[playerHat] == 13350 && playerEquipment[playerLegs] == 13346 && playerEquipment[playerChest] == 13348) {
			return true;
		}
		return false;
	}
	...
	public int specMaxHitIncrease, freezeDelay, freezeTimer = -6, killerId,
			...
			crystalBowArrowCount, playerMagicBook, teleGfx, teleEndAnimation, teleEndGfx,
	...
	public boolean inJail() {
		if (absX > 2864 && absX < 3062 && absY > 4967 && absY < 4980) {
			return true;
		}
		return false;
	}
	...
	public boolean inMulti() {
		if ((absX >= 3136 && absX <= 3327 && absY >= 3519 && absY <= 3607)
				...
				|| (absX >= 2822 && absX <= 2851 && absY >= 9803 && absY <= 9820)
