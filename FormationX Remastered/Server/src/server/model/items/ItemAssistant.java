		...
		if (c.getOutStream() != null && c != null) {
			if (c.playerEquipment[slot] > -1) {
				if (addItem(c.playerEquipment[slot], c.playerEquipmentN[slot])) {
					if (c.playerEquipment[slot] == 13362 || c.playerEquipment[slot] == 13358 || c.playerEquipment[slot] == 13360 || c.playerEquipment[slot] == 13355 || c.playerEquipment[slot] == 13354 || c.playerEquipment[slot] == 13352 || c.playerEquipment[slot] == 13350 || c.playerEquipment[slot] == 13348 || c.playerEquipment[slot] == 13346)
						torvaChanged = true;
