...
SpiritShields.ItemonItem(c, itemUsed, useWith);
OrnamentsKit.ItemonItem(c, itemUsed, useWith);
WeaponRecoloring.ItemonItem(c, itemUsed, useWith);
		...
		if ((itemUsed == 1540 && useWith == 11286) || (itemUsed == 11286 && useWith == 1540)) {
			if (c.playerLevel[c.playerSmithing] >= 80) {
				...
				c.sendMessage("You need a smithing level of 80 to create a dragonfire shield.");
			}
		}
		// Spirit shield
		if ((itemUsed == 13754 && useWith == 13734) || (itemUsed == 13734 && useWith == 13754)) {
