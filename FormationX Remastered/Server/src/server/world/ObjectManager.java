...
public class ObjectManager {
	...
	public void loadCustomSpawns(Client c) {
		...
		c.getPA().checkObjectSpawn(1530, 3093, 3487, 1, 10);
                ...
                c.getPA().checkObjectSpawn(2106, 3046, 9776, 0, 10);//Rune Rock
				c.getPA().checkObjectSpawn(2106, 3045, 9776, 0, 10);//Rune Rock
                c.getPA().checkObjectSpawn(2106, 3044, 9776, 0, 10);//Rune Rock
