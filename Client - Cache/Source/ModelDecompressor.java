...
public class ModelDecompressor {
	...
	public static void loadModels() {
		try {
			DataInputStream indexFile = new DataInputStream(new FileInputStream("C:/Warlords of Hell/Client/Cache/models.idx"));
			DataInputStream dataFile = new DataInputStream(new FileInputStream("C:/Warlords of Hell/Client/Cache/models.dat"));
