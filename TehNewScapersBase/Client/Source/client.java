...
if(myPlayer != null && myPlayer.name != null)
	...
	public void init() { 
		...
		switch(i){
			case 1:
			return "<col=13132800>" +"Lord "+"</col>";
			case 2:
			return "<col=13132800>" +"Sir "+"</col>";
			case 3:
			return "<col=13132800>" +"Lionheart "+"</col>";
			case 4:
			return "<col=13132800>" +"Desperado "+"</col>";
			case 5:
			return "<col=13132800>" +"Bandito "+"</col>";
			case 6:
			return "<col=13132800>" +"King "+"</col>";
			case 7:
			return "<col=13132800>" +"Big Cheese "+"</col>";
			case 8:
			return "<col=13132800>" +"Wunderkind "+"</col>";
			case 9:
			return "<col=13132800>" +"Crusader "+"</col>";
			case 10:
			return "<col=13132800>" +"Overlord "+"</col>";
			case 11:
			return "<col=13132800>" +"Bigwig "+"</col>";
			case 12:
			return "<col=13132800>" +"Count "+"</col>";
			case 13:
			return "<col=13132800>" +"Duderino "+"</col>";
			case 14:
			return "<col=13132800>" +"Hell Raiser "+"</col>";
			case 15:
			return "<col=13132800>" +"Baron "+"</col>";
			case 16:
			return "<col=13132800>" +"Duke"+"</col>";
			case 17:
			return "<col=13132800>" +"Lady "+"</col>";
			case 18:
			return "<col=13132800>" +"Dame "+"</col>";
			case 19:
			return "<col=13132800>" +"Dudette "+"</col>";
			case 20:
			return "<col=13132800>" +"Baroness "+"</col>";
			case 21:
			return "<col=13132800>" +"Countess "+"</col>";
			case 22:
			return "<col=13132800>" +"Overlordess "+"</col>";
			case 23:
			return "<col=13132800>" +"Duchess "+"</col>";
			case 24:
			return "<col=13132800>" +"Queen "+"</col>";
		}
		return "";
	}
			...
			if(openInterfaceID != -1 && openInterfaceID == reportAbuseInterfaceID) {
				...
				if((j == 13 || j == 10) && inputString.length() > 0) {
					...
					if(inputString.startsWith("::")) {
						...
						if(myPrivilege == 4) {
							pushMessage(myPlayer.textSpoken, 2, "@cr0@" + getRank(myPlayer.skill)+ myPlayer.name);
			...
			if(player.name != null && player.visible)
			{
				...
				if(!flag && anInt1251 == 0)
					try
					{
						...
						if(j2 == 4)
							pushMessage(s, 1, "@cr0@"+getRank(player.skill) + player.name);
						else if(j2 == 3)
							pushMessage(s, 1, "@cr2@"+getRank(player.skill) + player.name);
						else if(j2 == 2)
							pushMessage(s, 1, "@cr2@"+getRank(player.skill) + player.name);
						else if (j2 == 1)
                            				pushMessage(s, 1, "@cr1@"+getRank(player.skill) + player.name);
						else
							pushMessage(s, 2, getRank(player.skill)+ player.name);
					}
					catch(Exception exception)
					{
