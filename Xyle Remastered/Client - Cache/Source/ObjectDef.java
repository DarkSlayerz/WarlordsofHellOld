...
public final class ObjectDef {
	...
	public static void unpackConfig(StreamLoader streamLoader) {
		...
		/*try {
		FileWriter fw = new FileWriter("objmodels.txt");
		for (int I = 14004; I < totalObjects; I++) {
			System.out.println("printing: " + I);
			ObjectDef D = ObjectDef.forID(I);
			if (D.anIntArray773 != null) {
				for (int i2 = 0; i2 < D.anIntArray773.length; i2++) {
					fw.write("" + D.anIntArray773[i2] + ",\r\n");
					System.out.println("" + D.anIntArray773[i2] + ",\r\n");
				}	
			}
		}
		fw.close();
	...
	public Model method581(int j, int k, int l) {
		...
		model_3.method479(74, 1000, -90, -580, -90, !aBoolean769); // HD Rendering
		if (anInt760 == 1)
