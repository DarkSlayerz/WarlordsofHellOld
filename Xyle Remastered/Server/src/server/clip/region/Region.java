...
public class Region {
	...
	public static Tile getTile(int x, int y, int z) {
                return new Tile(getClipping(x, y, z));
        }
       
        public static class Tile {
                public Tile(int transversalMask) {
                        this.transversalMask = transversalMask;
                }
                private int transversalMask;
               
                public int getTransversalMask() {      
                        return transversalMask;
                }
 
                public boolean isNorthernTraversalPermitted() {
                        return (transversalMask & 0x1280102) == 0;
                }
       
                public boolean isEasternTraversalPermitted() {
                        return (transversalMask & 0x1280108) == 0;
                }
 
                public boolean isSouthernTraversalPermitted() {
                        return (transversalMask & 0x1280120) == 0;
                }
 
                public boolean isWesternTraversalPermitted() {
                        return (transversalMask & 0x1280180) == 0;
                }
        }
