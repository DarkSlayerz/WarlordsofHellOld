  ...
  return bonuses;
	...
	**/
	...
	public void sendWeapon(int Weapon, String WeaponName) {
		...
		} else if (WeaponName2.startsWith("dagger") || WeaponName2.contains("sword") && !WeaponName2.contains("godsword") && !WeaponName2.contains("Vesta's")) {
	...
	**/
	...
	public void getRequirements(String itemName, int itemId) {
		...
		switch(itemId) {
			...
			break;
			case 9185:
			c.rangeLevelReq = 61;//this wnt fucking work for some reason BUT OK OK FUCKING FFAGAFKA
			break;
			case 2503:
			c.defenceLevelReq = 40;
			c.rangeLevelReq = 70;
