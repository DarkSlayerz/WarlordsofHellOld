...
public abstract class Player {
	...
	public int clawDelay, clawTarg, clawTargNPC, hit1, hit2, hit3, hit4 = -1;
	...
	/* Attacking styles 
		Updated by Underoath from Rune-server.org */
	...
	public int teleGrabItem, teleGrabX, teleGrabY, duelCount, underAttackBy, underAttackBy2, wildLevel, teleTimer, respawnTimer = 0, teleBlockLength, poisonDelay;
	...
	public final int[] BOWS = 	{9185,18357,15241839,845,847,851,855,859,841,843,849,853,857,861,4212,4214,4215,11235,4216,4217,4218,4219,4220,4221,4222,4223,6724,4734,4934,4935,4936,4937};
	public final int[] ARROWS = {882,884,886,888,890,892,4740,11212,9140,9141,4142,9143,9144,9240,9241,9242,9243,9244,9245,15243};
	...
	{12445,85,1819,1841,1842,1843,0,65,563,1,562,1,560,1,0,0}, // teleblock
	...
	public boolean newPlayer()
	{
		if (joinTime == -1)
			...
			return (System.currentTimeMillis() - joinTime <= 900000);//15 minutes
	}
	public String getTimeLeftForNP()
	{
		long millis = System.currentTimeMillis() - joinTime;
		int minutes = (int) ((millis/ 1000) / 60);
		return ""+(15-minutes)+" minutes left before you can offer items in trade, drop, and lose items on death.";
	}
	...
	public boolean fullStatius() {
		return playerEquipment[playerChest] == 13884 && playerEquipment[playerLegs] == 13890 && playerEquipment[playerHat] == 13896;
	}
	...
	public boolean inBarbDef() {		
		if(absX > 3160 && absX < 3176 && absY > 9755 && absY < 9761) {
			return true;
		}
		return false;
	}
	   public boolean inZombieGame() {
      return absX >= 0001 && absX <= 0001 && absY >= 0001 && absY <= 0001;
   }
   
   public boolean inZombieWait() {
      return absX >= 0000 && absX <= 0001 && absY >= 0000 && absY <= 0001;
   }
	...
	protected void appendPlayerAppearance(Stream str) {
		...
		synchronized(this) {
			...
			playerProps.writeWord(maxConstitution);
	...
	**/
	...
	public void dealDamage(int damage) {
		...
		int prayerDamage = (int)(damage * .015);
