...
public class PlayerAssistant{
	...
	**/
	...
	public void magicOnItems(int slot, int itemId, int spellId) {
		switch(spellId) {
			...
			break;
			default:
				c.sendMessage("Spell id:" + spellId);
			break;
		}
	}
		...
		if(c.duelStatus != 6) {
			...
			if(o != null) {
				if (c.killerId != c.playerId) {
					...
					if (!c.connectedFrom.equals(o.lastKilled) && !c.newPlayer()) {
						o.pkp++;
	...
	**/
	...
	public void startTeleport2(int x, int y, int height) {
		...
		c.getSummoning().dismissFamiliar(true);
		c.getSummoning().renewTimer = 5;
...
c.sendMessage("Type ::commands to begin.");
	...
	/*this was commented out in combatassistant due to poison hitmarks not appearing*/
	...
	public void destroyInterface(int itemId) {
		...
		String[][] info = {{"Are you sure you want to destroy this item?", "14174"}, {"Yes.", "14175"}, {"No.", "14176"}, {"", "14177"}, {"Put info here", "14182"}, 
							{"More info here", "14183"}, {itemName, "14184"}};//make some kind of c.getItemInfo
