...
public class BankAll implements PacketType {
	...
	int removeId = c.getInStream().readUnsignedWordA();
		...
		switch(interfaceId){			
			case 24006:
				c.getSummoning().depositItem(removeId, removeSlot, c.getItems().itemAmount(c.playerItems[removeSlot]));
				break;
			case 24002:
				c.getSummoning().withdrawItem(removeId, c.getSummoning().getItemCount(removeId));
				break;
			case 3900:
