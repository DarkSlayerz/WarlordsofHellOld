...
import server.model.npcs.EmoteHandler;
...
public class Server {
	...
	public static void main(java.lang.String args[]) throws NullPointerException, IOException {
		...
		System.out.println("Initilizing Warlords of Hell...");
		try {
		 ...
		 */
		System.out.println("Accepting connections on port 5.175.193.189 - " + serverlistenerPort);
		/**
		 * Main Server Tick
		 */
		try {
