...
public class Config {
	...
	public static final String SERVER_NAME = "@blu@Xyle.";
	public static final String WELCOME_MESSAGE = "@blu@Type ::vote for 1000 pk points";
	...
	*OTHER
	*/
 	"fire cape", "korasi","onyx","3rd","handcannon", "light"
	};
